...
<form method="POST" action="{{ route('metadatos.educacional.update',$proyecto) }}">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="educacional_p7" id="educacional_p7" value="{{ $proyecto->desarrollo->metadatos->educacional->educacional_p7 }}" required>				
	</div>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="educacional_p9" id="educacional_p9" value="{{ $proyecto->desarrollo->metadatos->educacional->educacional_p9 }}" required>
	</div>		
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="educacional_p10" id="educacional_p10" value="{{ $proyecto->desarrollo->metadatos->educacional->educacional_p10 }}" required>
	</div>	
