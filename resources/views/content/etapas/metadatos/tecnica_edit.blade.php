<!--CATEGORÍA 4-->
<form method="POST" action="{{ route('metadatos.tecnica.update', $proyecto) }}">
	{{ csrf_field() }}
	@method('PATCH')
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="tecnica_p2" id="tecnica_p2" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p2}}" required>	
	</div>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="tecnica_p3" id="tecnica_p3" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p3 }}" required>
	</div>	
	...
	<div class="form-group">
		...
		<div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="tecnica_p4_2" id="tecnica_p4_2" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p4_2}}" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="tecnica_p4_3" id="tecnica_p4_3" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p4_3}}" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="tecnica_p4_4" id="tecnica_p4_4" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p4_4}}" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="tecnica_p4_5" id="tecnica_p4_5" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p4_5 }}" required>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="tecnica_p4_6" id="tecnica_p4_6" value="{{ $proyecto->desarrollo->metadatos->tecnica->tecnica_p4_6 }}" required>
			</div>
		</div>
	</div>
