	...
	<div class="container-fluid text-left">
		...
		<div class="bloque-meta">
			...
			<div class="form-group">
				...
				<select class="form-control" name="relacion_p1_rel_1" id="relacion_p1_rel_1" value="{{ $proyecto->desarrollo->metadatos->relacion->relacion_p1_rel_1 }}" required>
					<option selected>{{ $proyecto->desarrollo->metadatos->relacion->relacion_p1_rel_1 }}</option>
