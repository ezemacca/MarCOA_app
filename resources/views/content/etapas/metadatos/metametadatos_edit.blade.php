...
<form method="POST" action="{{ route('metadatos.metametadatos.update', $proyecto) }}">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="metametadatos_p1" id="metametadatos_p1" value="{{ $proyecto->desarrollo->metadatos->Metametadatos->metametadatos_p1}}" required>
	</div>	
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="metametadatos_p3" id="metametadatos_p3" value="{{ $proyecto->desarrollo->metadatos->Metametadatos->metametadatos_p3 }}" required>
	</div>	
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="metametadatos_p4" id="metametadatos_p4" value="{{ $proyecto->desarrollo->metadatos->Metametadatos->metametadatos_p4 }}" required>
	</div>		
