			...
			<form method="POST" action="{{ url('diseño') }}">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="diseño_inst_p1" id="diseño_inst_p1" value="{{ old('diseño_inst_p1') }}" required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="diseño_inst_p2" id="diseño_inst_p2" value="{{ old('diseño_inst_p2') }}" required>
				</div>	
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="diseño_inst_p3" id="diseño_inst_p3" value="{{ old('diseño_inst_p3') }}" required>
				</div>	
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="diseño_inst_p4" id="diseño_inst_p4" value="{{ old('diseño_inst_p4') }}" required>
				</div>				
