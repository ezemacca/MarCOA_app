  ...
  <body>
    <div>
      ...
      <div class="analisis-container">
        <img
          alt="image"
          src="{{ public_path('playground_assets/CabeceraInstruccional.png')}}"
          class="analisis-image"
        />
      <div class="centrado">
        <div class="analisis-analisis">
          <span class="analisis-titulo">
1. ¿Qué objetivo de aprendizaje específico se propone para el OA?
          </span>
          <span class="analisis-text">
            
            {!! $instruccional->instruccional_p1 !!} 
            
          </span>
          <br><br><hr><br>
           <span class="analisis-titulo">
2. ¿Qué información proveerá el OA acerca del tema a tratar? ¿Cómo se organizará y presentará la información?
          </span>
          <span class="analisis-text">
            
            {!! $instruccional->instruccional_p2 !!} 
            
          </span>
          <br><br><hr><br><br>
           <span class="analisis-titulo">
3. ¿Qué actividades se le propondrán al alumno?
          </span>
          <span class="analisis-text">
            
            {!! $instruccional->instruccional_p3 !!} 
            
          </span>
          <br><br><hr><br><br>
           <span class="analisis-titulo">
4. ¿En qué consistirá la autoevaluación? ¿De qué manera se dará feedback al alumno sobre su desempeño?
          </span>
          <span class="analisis-text">
            
            {!! $instruccional->instruccional_p4 !!} 
