...
<form method="POST" id="formulario1" action="{{ route('multimedial.update',$proyecto) }}">
	{{ csrf_field() }}
	@method('PATCH')
	...
	<div class="form-group">
		...
		<textarea type="text" class="form-control" name="diseño_mult_p1" id="diseño_mult_p1"  required>{{ $multimedial->diseño_mult_p1 }}
		</textarea>
		<script>
			ClassicEditor
				.create( document.querySelector( '#diseño_mult_p1' ), {
					language: "es"
				} )
				.then( editor => {
					console.log( editor );
			...
			<div class="row">
				<div class="col text-left">
							<button type="submit" form="formulario1" class="btn btn-secondary e-diseño">
				...
				<div class="col text-right">						
						<a class="btn btn-secondary boton-generar" href="{{route('multimedial.pdf', $proyecto->id)}}" role="button">
